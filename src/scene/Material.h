...
class Material {
public:
  enum Shading { SHADING_CONSTANT, SHADING_PHONG, SHADING_BLINN };

  Material(const std::string &name)
      : m_name(name), m_specularIntensity(0.5), m_specularGlossiness(16),
        m_specularColor(Color(1.0, 1.0, 1.0)),
        m_diffuseColor(Color(0.9, 0.9, 0.9)),
        m_ambientColor(Color(0.5, 0.5, 0.5)), m_reflection(false),
        m_refraction(false), m_fresnelExponent(1.0), m_ior(1.0),
        m_absorption(0.0), m_glossy(false), m_glossyRoughness(0.0),
        m_glossySamples(4), m_emission(0.0) {}

  Material(const std::string &name, const Color &diffuse)
      : m_name(name), m_specularIntensity(0.5), m_specularGlossiness(16),
        m_specularColor(Color(1.0, 1.0, 1.0)), m_diffuseColor(diffuse),
        m_ambientColor(diffuse), m_reflection(false), m_refraction(false),
        m_fresnelExponent(1.0), m_ior(1.0), m_absorption(0.0), m_glossy(false),
        m_glossyRoughness(0.0), m_glossySamples(4), m_emission(0.0) {}
  ...
  void setFresnelExponent(const double fresnelExponent) {
    m_fresnelExponent = fresnelExponent;
  }
  ...
  void setGlossySamples(const unsigned int samples) {
    m_glossySamples = samples;
  }

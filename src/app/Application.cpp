...
void Application::onRenderEnd() {
  ...
  std::cout << "  Primary rays: " << m_core->getPrimaryRaysCount() << std::endl;

  std::cout << "  Secondary rays: " << m_core->getSecondaryRaysCount()
            << std::endl;
}
...
void Application::onBucketStart(const Bucket &bucket) {
  ...
  */
  ...
  if (n == 0)
    ...
    color = COLOR(255, 128, 255, 128);
  else if (n == 9)
    color = COLOR(255, 128, 128, 255);
  else if (n == 10)
    color = COLOR(255, 255, 255, 128);
  else if (n == 11)
    color = COLOR(255, 128, 255, 255);
  else if (n == 12)
    color = COLOR(255, 255, 128, 255);
  else if (n == 13)
    color = COLOR(255, 255, 128, 0);
  else if (n == 14)
    color = COLOR(255, 255, 0, 128);
  else if (n == 15)
    color = COLOR(255, 128, 255, 0);
  else if (n == 16)
...
void Application::execute(const std::string &fileName,
                          const unsigned int aaSamples) {
  Scene scene(NULL);

  const double ratio =
      m_frameBuffer->getWidth() / (double)m_frameBuffer->getHeight();
  ...
  writePNG(m_display->getBackBuffer(), m_frameBuffer->getWidth(),
           m_frameBuffer->getHeight(), fileName);
